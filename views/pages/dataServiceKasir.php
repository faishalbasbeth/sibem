  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class= "active"><a href="dataServiceKasir.html"><span class="glyphicon glyphicon-wrench"></span> Data Service</a></li>
      ...
      <div class="col-md-11">
        <div class="panel panel-default">
          <div class="panel-body">
            <a href="?controller=data_service&action=tampilService" class="btn btn-success btn-sm" title="Add New Data Service">
              <i></i> Add New
            </a>
              ...
              <table class="table table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th>Keluhan</th>
                    <th>Jenis Service</th>
                    <th>Sparepart Satu</th>
                    <th>Sparepart Dua</th>
                    <th>Sparepart Tiga</th>
                    <th>Harga Total</th>
                    <?php $i=1; ?>
                ...
                <tbody id="myTable">
                  ...
                  <td><?php echo $post->keluhan; ?></td>
                  <td><?php echo $post->jenis_service; ?></td>
                  <td><?php echo $post->sparepart_satu; ?></td>
                  <td><?php echo $post->sparepart_dua; ?></td>
                  <td><?php echo $post->sparepart_tiga; ?></td>
                  <td><?php echo $post->harga_total; ?></td>
