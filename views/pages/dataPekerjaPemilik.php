  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a href="?controller=data_pekerja&action=pekerja"><span class="glyphicon glyphicon-user"></span> Data Pekerja</a></li>
      ...
      <div class="col-md-11">
        <div class="panel panel-default">
          <div class="panel-body">
            <a href="?controller=data_pekerja&action=tampilPekerja" class="btn btn-success btn-sm" title="Add New Sparepart">
              <i></i> Add New
            </a>
            ...
            <div class="rectangle">
              <table class="table table-bordered table-striped">
                ...
                <tbody id="myTable">
                  <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $post->nama_user; ?></td>
                  <td><?php echo $post->hak_akses; ?></td>
...
<!--                      <form method="POST" action="#" accept-charset="UTF-8" style="display:inline"><input name="_method" type="hidden" value="DELETE"><input name="_token" type="hidden" value="FEl9jLiZgc3BVOsYTzUt7ReWMBYPxTVZGa4crtre">
                    ...
                    <a href="?controller=data_pekerja&action=deletePekerja&id_user=<?php echo $post->id_user ?>" title="Edit driver"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Hapus</button></a>                    
                  </td>
                  </tr>  <?php $i++;} ?>  
